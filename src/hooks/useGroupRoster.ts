 ...
 * outcome, then displayName; dense-ranked (ties share a rank, surfaced as "T-N" by the UI).
 *
...
/** Rank the merged roster: points desc, then exact, outcome, then displayName asc. */
