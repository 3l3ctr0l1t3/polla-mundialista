  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // Screenshots unlock Chrome's RICHER install UI. At least one `wide`
        // (desktop) and one non-`wide` (mobile) are required, else Chrome warns
        // and falls back to the minimal install. Generated by
        // `npm run generate-screenshots` (scripts/gen-screenshots.mjs).
        screenshots: [
          {
            ...
            type: 'image/png',
            form_factor: 'wide',
            label: 'Fixtures and live group leaderboard',
          },
          {
            ...
            type: 'image/png',
            form_factor: 'narrow',
            label: 'Predict fixtures and climb your group leaderboard',
          },
        ],
      },
